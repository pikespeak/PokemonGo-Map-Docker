...
CMD cd /home/PokemonGo-Map && python /home/PokemonGo-Map/runserver.py -a google -u $pokemon_Username -p $pokemon_Password -l $pokemon_Location -s $pokemon_StepLimit -k $pokemon_Gmapskey -H 0.0.0.0
